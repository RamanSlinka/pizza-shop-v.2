    ...
    return (
        <>
            {isAuth ?
                ...
                :
                <div className="cart__registration__wrapper">
                    <div className="cart__registration__container">
                        <div className="cart__registration__content">
                            <h1 className="cart__registration__title">Log in to use the shopping cart</h1>
